 ...
 * then it is going to be used by `exec` and no autodetect will happen.
...
/**
 * @class
 * @classdesc The main class, which is used to manage the Simulator.
 */
class Simctl {
  /**
   * Create a Simctl.
   * @param {SimctlOpts} [opts] - The set of options, which are going to be used
   */
  constructor (opts = {}) {
   ...
   * `SubProcess` instance depending on `opts.asynchronous` value.
